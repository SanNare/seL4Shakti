#ifndef _HOME_SANDIP_DESKTOP_TEST_SEL_BUILD_RISCV_KERNEL_GENERATED_ARCH_OBJECT_STRUCTURES_GEN_H
#define _HOME_SANDIP_DESKTOP_TEST_SEL_BUILD_RISCV_KERNEL_GENERATED_ARCH_OBJECT_STRUCTURES_GEN_H
...
pte_new(uint64_t ppn, uint64_t sw, uint64_t dirty, uint64_t accessed, uint64_t global, uint64_t user, uint64_t execute, uint64_t write, uint64_t read, uint64_t valid) {
    ...
    /* fail if user has passed bits that we will override */  
    assert((ppn & ~0xfffffffffffull) == ((1 && (ppn & (1ull << 47))) ? 0x0 : 0));  
    assert((sw & ~0x3ull) == ((1 && (sw & (1ull << 47))) ? 0x0 : 0));  
    assert((dirty & ~0x1ull) == ((1 && (dirty & (1ull << 47))) ? 0x0 : 0));  
    assert((accessed & ~0x1ull) == ((1 && (accessed & (1ull << 47))) ? 0x0 : 0));  
    assert((global & ~0x1ull) == ((1 && (global & (1ull << 47))) ? 0x0 : 0));  
    assert((user & ~0x1ull) == ((1 && (user & (1ull << 47))) ? 0x0 : 0));  
    assert((execute & ~0x1ull) == ((1 && (execute & (1ull << 47))) ? 0x0 : 0));  
    assert((write & ~0x1ull) == ((1 && (write & (1ull << 47))) ? 0x0 : 0));  
    assert((read & ~0x1ull) == ((1 && (read & (1ull << 47))) ? 0x0 : 0));  
    assert((valid & ~0x1ull) == ((1 && (valid & (1ull << 47))) ? 0x0 : 0));
...
satp_new(uint64_t mode, uint64_t asid, uint64_t ppn) {
    ...
    /* fail if user has passed bits that we will override */  
    assert((mode & ~0xfull) == ((1 && (mode & (1ull << 47))) ? 0x0 : 0));  
    assert((asid & ~0xffffull) == ((1 && (asid & (1ull << 47))) ? 0x0 : 0));  
    assert((ppn & ~0xfffffffffffull) == ((1 && (ppn & (1ull << 47))) ? 0x0 : 0));
...
cap_frame_cap_new(uint64_t capFMappedASID, uint64_t capFBasePtr, uint64_t capFSize, uint64_t capFVMRights, uint64_t capFIsDevice, uint64_t capFMappedAddress) {
    ...
    assert((capFVMRights & ~0x7ull) == ((1 && (capFVMRights & (1ull << 47))) ? 0x0 : 0));  
...
cap_frame_cap_set_capFVMRights(cap_t cap, uint64_t v64) {
    assert(((cap.words[0] >> 59) & 0x1f) ==
           cap_frame_cap);
    /* fail if user has passed bits that we will override */
    assert((((~0x1c0000000000000ull >> 54 ) | 0x0) & v64) == ((0 && (v64 & (1ull << (47)))) ? 0x0 : 0));
...
cap_page_table_cap_new(uint64_t capPTMappedASID, uint64_t capPTBasePtr, uint64_t capPTIsMapped, uint64_t capPTMappedAddress) {
    ...
    assert((capPTMappedAddress & ~0xffffffffffffull) == ((1 && (capPTMappedAddress & (1ull << 47))) ? 0xffff000000000000 : 0));
...
seL4_Fault_NullFault_new(void) {
    ...
    /* fail if user has passed bits that we will override */  
    assert(((uint64_t)seL4_Fault_NullFault & ~0x7ull) == ((1 && ((uint64_t)seL4_Fault_NullFault & (1ull << 47))) ? 0x0 : 0));
...
seL4_Fault_CapFault_new(uint64_t address, uint64_t inReceivePhase) {
    ...
    /* fail if user has passed bits that we will override */  
    assert((inReceivePhase & ~0x1ull) == ((1 && (inReceivePhase & (1ull << 47))) ? 0x0 : 0));  
    assert(((uint64_t)seL4_Fault_CapFault & ~0x7ull) == ((1 && ((uint64_t)seL4_Fault_CapFault & (1ull << 47))) ? 0x0 : 0));
...
seL4_Fault_UnknownSyscall_new(uint64_t syscallNumber) {
    ...
    /* fail if user has passed bits that we will override */  
    assert(((uint64_t)seL4_Fault_UnknownSyscall & ~0x7ull) == ((1 && ((uint64_t)seL4_Fault_UnknownSyscall & (1ull << 47))) ? 0x0 : 0));
...
seL4_Fault_UserException_new(uint64_t number, uint64_t code) {
    ...
    /* fail if user has passed bits that we will override */  
    assert((number & ~0xffffffffull) == ((1 && (number & (1ull << 47))) ? 0x0 : 0));  
    assert((code & ~0x1fffffffull) == ((1 && (code & (1ull << 47))) ? 0x0 : 0));  
    assert(((uint64_t)seL4_Fault_UserException & ~0x7ull) == ((1 && ((uint64_t)seL4_Fault_UserException & (1ull << 47))) ? 0x0 : 0));
...
seL4_Fault_VMFault_new(uint64_t address, uint64_t FSR, uint64_t instructionFault) {
    ...
    /* fail if user has passed bits that we will override */  
    assert((FSR & ~0x1full) == ((1 && (FSR & (1ull << 47))) ? 0x0 : 0));  
    assert((instructionFault & ~0x1ull) == ((1 && (instructionFault & (1ull << 47))) ? 0x0 : 0));  
    assert(((uint64_t)seL4_Fault_VMFault & ~0x7ull) == ((1 && ((uint64_t)seL4_Fault_VMFault & (1ull << 47))) ? 0x0 : 0));
