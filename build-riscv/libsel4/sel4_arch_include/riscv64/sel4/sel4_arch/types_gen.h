#ifndef _HOME_SANDIP_DESKTOP_TEST_SEL_BUILD_RISCV_LIBSEL4_SEL4_ARCH_INCLUDE_RISCV64_SEL4_SEL4_ARCH_TYPES_GEN_H
#define _HOME_SANDIP_DESKTOP_TEST_SEL_BUILD_RISCV_LIBSEL4_SEL4_ARCH_INCLUDE_RISCV64_SEL4_SEL4_ARCH_TYPES_GEN_H
...
LIBSEL4_INLINE_FUNC seL4_Fault_t CONST
seL4_Fault_UserException_new(seL4_Uint64 FaultIP, seL4_Uint64 SP, seL4_Uint64 FLAGS, seL4_Uint64 Number, seL4_Uint64 Code) {
    seL4_Fault_t seL4_Fault;
...
LIBSEL4_INLINE_FUNC void
seL4_Fault_UserException_ptr_new(seL4_Fault_t *seL4_Fault_ptr, seL4_Uint64 FaultIP, seL4_Uint64 SP, seL4_Uint64 FLAGS, seL4_Uint64 Number, seL4_Uint64 Code) {
    /* fail if user has passed bits that we will override */  
    seL4_DebugAssert(((seL4_Uint64)seL4_Fault_UserException & ~0x7ull) == ((0 && ((seL4_Uint64)seL4_Fault_UserException & (1ull << 63))) ? 0x0 : 0));
