...
seL4_TCB_ReadRegisters(seL4_TCB _service, seL4_Bool suspend_source, seL4_Uint8 arch_flags, seL4_Word count, seL4_UserContext *regs)
{
	...
	regs->a7 = seL4_GetMR(17);
	regs->s2 = seL4_GetMR(18);
	regs->s3 = seL4_GetMR(19);
	regs->s4 = seL4_GetMR(20);
	regs->s5 = seL4_GetMR(21);
	regs->s6 = seL4_GetMR(22);
	regs->s7 = seL4_GetMR(23);
	regs->s8 = seL4_GetMR(24);
	regs->s9 = seL4_GetMR(25);
	regs->s10 = seL4_GetMR(26);
	regs->s11 = seL4_GetMR(27);
	regs->t3 = seL4_GetMR(28);
	regs->t4 = seL4_GetMR(29);
	regs->t5 = seL4_GetMR(30);
	regs->t6 = seL4_GetMR(31);
	return result;
}
...
seL4_TCB_WriteRegisters(seL4_TCB _service, seL4_Bool resume_target, seL4_Uint8 arch_flags, seL4_Word count, seL4_UserContext *regs)
{
	...
	seL4_SetMR(19, regs->a7);
	seL4_SetMR(20, regs->s2);
	seL4_SetMR(21, regs->s3);
	seL4_SetMR(22, regs->s4);
	seL4_SetMR(23, regs->s5);
	seL4_SetMR(24, regs->s6);
	seL4_SetMR(25, regs->s7);
	seL4_SetMR(26, regs->s8);
	seL4_SetMR(27, regs->s9);
	seL4_SetMR(28, regs->s10);
	seL4_SetMR(29, regs->s11);
	seL4_SetMR(30, regs->t3);
	seL4_SetMR(31, regs->t4);
	seL4_SetMR(32, regs->t5);
	seL4_SetMR(33, regs->t6);
